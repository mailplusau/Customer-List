...
function main(request, response) {
	if (request.getMethod() === "GET") {
		...
		form
			.addField("custpage_html2", "inlinehtml")
			.setPadding(1)
			.setLayoutType("outsideabove")
			.setDefaultValue(inlinehtml2);
		form
			.addField("preview_table", "inlinehtml", "")
			.setLayoutType("outsidebelow", "startrow")
			.setDefaultValue(inlineHtml);
